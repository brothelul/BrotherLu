package com.swjtu.aroundyou.web.controller.validatecode;
...
public class ValidateCode {
	...
	@RequestMapping(value="getValidateCodePng.do",method=RequestMethod.GET)
	...
	@ResponseBody
	public String validateCode(@RequestParam("code")String code,HttpSession session){
