...
function build_responsive_menu() {
	...
	if(full_nav != null) {
		$('header .section_main_menu .inner').append('<div id="responsive_navigation" class="responsive_navigation"><div class="button_menu">点我选你想知道的内容</div><div class="r_menu"></div></div>');
